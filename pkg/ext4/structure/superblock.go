...
func (this *Superblock) Read(io *kaitai.Stream, parent interface{}, root *Superblock) (err error) {
	...
	tmp43, err := this._io.ReadBytes(int(12))
	if err != nil {
		return err
	}
	tmp43 = tmp43
	...
	this.SFirstMetaBg = uint32(tmp44)
	tmp45, err := this._io.ReadU4le()
	if err != nil {
		return err
	}
	this.SMkfsTime = uint32(tmp45)
	tmp46, err := this._io.ReadBytes(int(68))
	if err != nil {
		return err
	}
	tmp46 = tmp46
	this.SJnlBlocks = tmp46
	tmp47, err := this._io.ReadU4le()
	if err != nil {
		return err
	}
	this.SBlocksCountHi = uint32(tmp47)
	tmp48, err := this._io.ReadU4le()
	if err != nil {
		return err
	}
	this.SRBlocksCountHi = uint32(tmp48)
	tmp49, err := this._io.ReadU4le()
	if err != nil {
		return err
	}
	this.SFreeBlocksCountHi = uint32(tmp49)
	tmp50, err := this._io.ReadU2le()
	if err != nil {
		return err
	}
	this.SMinExtraIsize = uint16(tmp50)
	tmp51, err := this._io.ReadU2le()
	if err != nil {
		return err
	}
	this.SWantExtraIsize = uint16(tmp51)
